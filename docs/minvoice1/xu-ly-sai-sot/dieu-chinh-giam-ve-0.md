...
![Hình 1](../../assets/images/invoice1/1.0_dieu-chinh-giam_1.png "Hãy bấm vào để xem rõ hơn")

### **Bước 2 : Bấm chọn hàng hóa để chọn lại hàng hóa của hóa đơn bị điều chỉnh**

![Hình 2](../../assets/images/invoice1/1.0_dieu-chinh-giam_2.png "Hãy bấm vào để xem rõ hơn")

![Hình 3](../../assets/images/invoice1/1.0_dieu-chinh-giam_3.png "Hãy bấm vào để xem rõ hơn")

### **Bước 3 : Điền âm số lượng hóa đơn**

![Hình 4](../../assets/images/invoice1/1.0_dieu-chinh-giam_4.png "Hãy bấm vào để xem rõ hơn")

### **Bước 4 : Kiểm tra các thông tin của hóa đơn -> LƯU**

![Hình 5](../../assets/images/invoice1/1.0_dieu-chinh-giam_5.png "Hãy bấm vào để xem rõ hơn")

Kiểm tra các thông tin hóa đơn nếu đúng thì bấm lưu

![Hình 6](../../assets/images/invoice1/1.0_dieu-chinh-giam_6.png "Hãy bấm vào để xem rõ hơn")
